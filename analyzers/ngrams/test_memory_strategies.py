...
from analyzers.ngrams.memory_strategies import ExternalSortUniqueExtractor, extract_unique_external_sort
...
class TestExternalSortUniqueExtractor:
    ...
    def test_extract_unique_small_dataset(self):
        ...
        test_data = pl.DataFrame({
            "ngram_text": ["apple banana", "banana cherry", "apple banana", "cherry date", "banana cherry"]
        })
    ...
    def test_create_sorted_chunks(self):
        ...
        memory_manager = MagicMock(spec=MemoryManager)
        memory_manager.calculate_adaptive_chunk_size.return_value = 2  # Very small chunks
        ...
        try:
            chunk_files = extractor._create_sorted_chunks(test_data.lazy(), "ngram_text")
...
class TestFallbackProcessors:
    ...
    def test_stream_unique_memory_optimized(self):
        ...
        # Create test data with duplicates
        test_data = pl.DataFrame({
            "ngram_text": ["apple", "banana", "apple", "cherry", "banana", "date", "apple"]
        })
...
class TestMemoryStrategiesIntegration:
    ...
    def test_large_dataset_external_sort(self):
        ...
        base_ngrams = ["apple banana", "banana cherry", "cherry date", "date elderberry"]
    ...
    def test_fallback_strategy_selection(self):
        ...
        minimal_result = _generate_ngrams_minimal_memory(test_data.lazy(), min_n=2, max_n=2)
    ...
    def test_memory_cleanup_during_processing(self):
        ...
        memory_manager = MagicMock(spec=MemoryManager)
        memory_manager.calculate_adaptive_chunk_size.return_value = 1  # Very small chunks
