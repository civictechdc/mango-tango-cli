...
class TestMemoryManager:
    ...
    def test_get_current_memory_usage(self):
        ...
        required_fields = [
            'rss_bytes', 'vms_bytes', 'rss_mb', 'vms_mb', 'rss_gb',
            'system_available_gb', 'system_used_percent', 
            'process_memory_percent', 'pressure_level'
        ]
    ...
    def test_operation_specific_chunk_sizing(self):
        ...
        with patch.object(manager, 'get_memory_pressure_level') as mock_pressure:
            ...
            tokenization_size = manager.calculate_adaptive_chunk_size(base_size, "tokenization")
            ngram_size = manager.calculate_adaptive_chunk_size(base_size, "ngram_generation")
            unique_size = manager.calculate_adaptive_chunk_size(base_size, "unique_extraction")
...
class TestMemoryManagerIntegration:
    ...
    def test_adaptive_chunk_sizing_realistic_scenarios(self):
        ...
        operations = ["tokenization", "ngram_generation", "unique_extraction", "join_operations"]
        base_sizes = [10000, 50000, 100000]
        
        for operation in operations:
            for base_size in base_sizes:
                adaptive_size = manager.calculate_adaptive_chunk_size(base_size, operation)
