...
import type { Presenter, PresenterCollection } from '@/lib/types/presenters';
import type { GlobalPresentersState } from '@/lib/state/presenters';
import type { NgramPresenterStats } from '@/components/ngram_scatter';
...
export default function PresenterView(): ReactElement<FC> {
    ...
    if(presenter) {
        if (presenter.figure_type === 'scatter') component = <NgramScatterPlot presenter={presenter as NgramPresenterStats} />;
    }
