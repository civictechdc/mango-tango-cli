...
class TestMemoryAwareProgressManager:
    ...
    def test_update_step_with_memory_high_pressure(self):
        ...
        with patch.object(progress_manager, 'console'):
            progress_manager.update_step_with_memory("test_step", 75, "high pressure test")
    ...
    def test_update_step_with_memory_critical_pressure(self):
        ...
        with patch.object(progress_manager, 'console'), \
             patch.object(progress_manager, '_display_memory_warning') as mock_warning:
    ...
    def test_no_gc_reporting_for_small_cleanup(self):
        ...
        with patch.object(progress_manager, 'console') as mock_console:
            ...
            print_calls = [str(call) for call in mock_console.print.call_args_list]
            assert not any("Freed" in call and "MB memory" in call for call in print_calls)
...
class TestMemoryAwareProgressManagerIntegration:
    ...
    def test_full_analysis_simulation(self):
        ...
        memory_states = [
            ...
            {'rss_mb': 2500.0, 'process_memory_percent': 62.5, 'pressure_level': 'medium'},
            {'rss_mb': 3200.0, 'process_memory_percent': 80.0, 'pressure_level': 'high'},
            {'rss_mb': 2800.0, 'process_memory_percent': 70.0, 'pressure_level': 'medium'},  # After cleanup
        ]
        
        memory_manager.get_current_memory_usage.side_effect = memory_states
        memory_manager.should_trigger_gc.side_effect = [False, False, False, True, False]
        ...
        progress_manager = MemoryAwareProgressManager("Simulated Analysis", memory_manager)
