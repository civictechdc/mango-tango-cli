...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Mango Tango CLI - Social Media Data Analysis Tool")
    parser.add_argument(
        "--log-level",
    ...
    parser.add_argument(
        "--noop",
        action="store_true",
        help="No-operation mode for testing"
    )
    ...
    logger.info("Starting Mango Tango CLI application", extra={
